...
def add_distillation_cfg(cfg):
    ...
    cfg.KD = CN()
    cfg.KD.FEATURE_ON = False
    cfg.KD.FEATURE_LOSS_WEIGHT = 1.0
    cfg.KD.FEATURE_LEVEL = [0, 1, 2, 3, 4]

    cfg.KD.BOX_FEATURE_ON = False
    cfg.KD.BOX_FEATURE_LOSS_WEIGHT = 1.0
    cfg.KD.ROI_CLS_ON = False
    cfg.KD.ROI_CLS_LOSS_WEIGHT = 1.0
    cfg.KD.ROI_REG_ON = False
    cfg.KD.ROI_REG_LOSS_WEIGHT = 1.0
    cfg.KD.RPN_CLS_ON = False
    cfg.KD.RPN_CLS_LOSS_WEIGHT = 1.0
    cfg.KD.RPN_LOC_ON = False
    ...
    cfg.KD.REGION_CORRELATION_HEAD_LOSS = False
    cfg.KD.REGION_CORRELATION_POOL_LOSS = False

    cfg.KD.FEATURE_ROIPOOL_FG_LOSS_ON = False
    cfg.KD.FEATURE_ROIPOOL_FG_LOSS_WEIGHT = 1.0

    cfg.KD.FEATURE_ROIPOOL_BG_LOSS_ON = False
    cfg.KD.FEATURE_ROIPOOL_BG_LOSS_WEIGHT = 1.0

    cfg.KD.CORR_MAT_SIM_FUNCTION = "instance_sim"
    cfg.KD.CORR_MAT_SIMLOSS_REDUCTION = 'mean'

    cfg.KD.MINE_NUM_BG = 10
    cfg.KD.BG_MINING_THRS = 0.5
    cfg.KD.BG_FEATURE_MINING_ON = False
    cfg.KD.USE_BG_FEATURE_MINING_THRS = False

    cfg.KD.POOL_FEATURES_ADAPPOOL_2D = False

    cfg.KD.USE_BG_WEIGHT_SCALE = False
    cfg.KD.BG_WEIGHT_ALPHA = 1.0
...
def add_teacher_cfg(cfg):
    ...
    cfg.TEACHER.MODEL.VIT = CN()
    cfg.TEACHER.MODEL.VIT.ARCH = 'vit_base_patch16_224'
    cfg.TEACHER.MODEL.VIT.OUT_FEATURES = ["layer3", "layer5", "layer7", "layer11"]
    cfg.TEACHER.MODEL.VIT.DROP_PATH = 0.1
    cfg.TEACHER.MODEL.VIT.IMG_SIZE = 224
    cfg.TEACHER.MODEL.VIT.PATCH_SIZE = 16
    ...
    cfg.TEACHER.INPUT.MIN_SIZE_TRAIN = (224,)
    ...
    cfg.TEACHER.MODEL.BACKBONE.NAME = "build_vit_fpn_backbone" #"build_resnet_backbone"
    ...
    cfg.TEACHER.MODEL.PANOPTIC_FPN.COMBINE = CN({"ENABLED": True})
